...
export default function RulesView() {
    ...
    const BulletItem = ({ children }) => (
        <motion.li variants={bulletVariants} className="flex gap-3.5 items-start">
    ...
    return (
        ...
        >
            ...
            <div className="grid md:grid-cols-2 gap-5" style={{ fontFamily: '"Suwannaphum", "Outfit", sans-serif' }}>
                ...
                <motion.div variants={itemVariants} className="glass-card hover-lift p-7 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:border-cyan-500/15">
                    ...
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-3 relative z-10">
                        <div className="p-2 rounded-xl bg-blue-500/8 text-blue-400 border border-blue-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                ...
                <motion.div variants={itemVariants} className="glass-card hover-lift p-7 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:border-cyan-500/15">
                    ...
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-3 relative z-10">
                        <div className="p-2 rounded-xl bg-emerald-500/8 text-emerald-400 border border-emerald-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                    ...
                    <div className="space-y-4 relative z-10">
                        ...
                        <div className="pt-2">
                            ...
                            <motion.ol variants={listVariants} className="list-decimal list-inside text-sm text-slate-300 space-y-1 ml-1">
                                <motion.li variants={bulletVariants}>ពិន្ទុសរុប (PTS)</motion.li>
                                <motion.li variants={bulletVariants}>ផលសងគ្រាប់បាល់សរុប (GD)</motion.li>
                                <motion.li variants={bulletVariants}>គ្រាប់បាល់ស៊ុតបញ្ចូលទីបានសរុប (GF)</motion.li>
                                <motion.li variants={bulletVariants}>ប្រវត្តិជួបគ្នាផ្ទាល់ (Head-to-Head)</motion.li>
                                <motion.li variants={bulletVariants}>របូតគ្រាប់បាល់តិចជាងគេ (GA)</motion.li>
                            </motion.ol>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="glass-card hover-lift p-7 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:border-cyan-500/15">
                    ...
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-3 relative z-10">
                        <div className="p-2 rounded-xl bg-amber-500/8 text-amber-400 border border-amber-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                ...
                <motion.div variants={itemVariants} className="glass-card hover-lift p-7 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:border-cyan-500/15">
                    ...
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-3 relative z-10">
                        <div className="p-2 rounded-xl bg-purple-500/8 text-purple-400 border border-purple-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                ...
                <motion.div variants={itemVariants} className="glass-card hover-lift p-7 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:border-cyan-500/15">
                    ...
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-3 relative z-10">
                        <div className="p-2 rounded-xl bg-rose-500/8 text-rose-400 border border-rose-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                ...
                <motion.div variants={itemVariants} className="glass-card hover-lift p-7 rounded-2xl relative overflow-hidden group transition-all duration-300 hover:border-cyan-500/15">
                    ...
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-3 relative z-10">
                        <div className="p-2 rounded-xl bg-cyan-500/8 text-cyan-400 border border-cyan-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
                ...
                <motion.div variants={itemVariants} className="md:col-span-2 glass-card hover-lift p-7 sm:p-10 rounded-3xl relative overflow-hidden group mt-2 transition-all duration-300 hover:border-slate-500/20">
                    ...
                    <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3 relative z-10">
                        <div className="p-2.5 rounded-xl bg-slate-500/8 text-slate-400 border border-slate-500/10 transition-transform duration-300 group-hover:-translate-y-1 group-hover:scale-105">
