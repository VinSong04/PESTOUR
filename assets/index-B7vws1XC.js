 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,O){var D=N.length;N.push(O);e:for(;0<D;){var re=D-1>>>1,ue=N[re];if(0<s(ue,O))N[re]=O,N[D]=ue,D=re;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var O=N[0],D=N.pop();if(D!==O){N[0]=D;e:for(var re=0,ue=N.length,gi=ue>>>1;re<gi;){var En=2*(re+1)-1,Al=N[En],Sn=En+1,_i=N[Sn];if(0>s(Al,D))Sn<ue&&0>s(_i,Al)?(N[re]=_i,N[Sn]=D,re=Sn):(N[re]=Al,N[En]=D,re=En);else if(Sn<ue&&0>s(_i,D))N[re]=_i,N[Sn]=D,re=Sn;else break e}}return O}function s(N,O){var D=N.sortIndex-O.sortIndex;return D!==0?D:N.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;t.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],f=1,h=null,d=3,_=!1,v=!1,y=!1,C=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(N){for(var O=n(u);O!==null;){if(O.callback===null)r(u);else if(O.startTime<=N)r(u),O.sortIndex=O.expirationTime,e(a,O);else break;O=n(u)}}function w(N){if(y=!1,g(N),!v)if(n(a)!==null)v=!0,Pl(S);else{var O=n(u);O!==null&&Rl(w,O.startTime-N)}}function S(N,O){v=!1,y&&(y=!1,m(b),b=-1),_=!0;var D=d;try{for(g(O),h=n(a);h!==null&&(!(h.expirationTime>O)||N&&!Be());){var re=h.callback;if(typeof re=="function"){h.callback=null,d=h.priorityLevel;var ue=re(h.expirationTime<=O);O=t.unstable_now(),typeof ue=="function"?h.callback=ue:h===n(a)&&r(a),g(O)}else r(a);h=n(a)}if(h!==null)var gi=!0;else{var En=n(u);En!==null&&Rl(w,En.startTime-O),gi=!1}return gi}finally{h=null,d=D,_=!1}}var I=!1,T=null,b=-1,B=5,A=-1;function Be(){return!(t.unstable_now()-A<B)}function Yr(){if(T!==null){var N=t.unstable_now();A=N;var O=!0;try{O=T(!0,N)}finally{O?Xr():(I=!1,T=null)}}else I=!1}var Xr;if(typeof p=="function")Xr=function(){p(Yr)};else if(typeof MessageChannel<"u"){var Cd=new MessageChannel,Cv=Cd.port2;Cd.port1.onmessage=Yr,Xr=function(){Cv.postMessage(null)}}else Xr=function(){C(Yr,0)};function Pl(N){T=N,I||(I=!0,Xr())}function Rl(N,O){b=C(function(){N(t.unstable_now())},O)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){v||_||(v=!0,Pl(S))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(N){switch(d){case 1:case 2:case 3:var O=3;break;default:O=d}var D=d;d=O;try{return N()}finally{d=D}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,O){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var D=d;d=N;try{return O()}finally{d=D}},t.unstable_scheduleCallback=function(N,O,D){var re=t.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?re+D:re):D=re,N){case 1:var ue=-1;break;case 2:ue=250;break;case 5:ue=1073741823;break;case 4:ue=1e4;break;default:ue=5e3}return ue=D+ue,N={id:f++,callback:O,priorityLevel:N,startTime:D,expirationTime:ue,sortIndex:-1},D>re?(N.sortIndex=D,e(u,N),n(a)===null&&N===n(u)&&(y?(m(b),b=-1):y=!0,Rl(w,D-re))):(N.sortIndex=ue,e(a,N),v||_||(v=!0,Pl(S))),N},t.unstable_shouldYield=Be,t.unstable_wrapCallback=function(N){var O=d;return function(){var D=d;d=O;try{return N.apply(this,arguments)}finally{d=D}}}})(up);ap.exports=up;var qv=ap.exports;/**
 * @license React
